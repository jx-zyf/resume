...
(function() {
  ...
  $('body').append("  <style id=\"style-tag\"></style>\n<span id=\"echo\"></span>\n<span id=\"heart\"><i></i></span>\n<pre id=\"style-text\"></pre>\n  <div style = 'position: fixed; left: 0; bottom: 0; background-color: #eee; z-index: 99; width: 100vw; padding: 12px 24px;'>\n    <a style='color: #0094ff' id='skipAnimation' href='javascript:;'>跳过动画</a>\n    <a style='color: #0094ff; margin-left: 12px;' id='restart' href='javascript:;'>重新播放</a>\n  </div>");
